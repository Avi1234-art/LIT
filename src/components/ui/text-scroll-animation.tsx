...
const CharacterV1 = ({
  ...
  return (
    <motion.span
      className={cn("inline-block text-emerald-400", charClassName, isSpace && "w-4")}
      style={{ x, rotateX }}
    >
      {char}
    </motion.span>
  ...
  return (
    <ReactLenis root>
      <main className="w-full bg-black">
        {/* Scroll hint */}
        <div className="top-22 absolute left-1/2 z-10 grid -translate-x-1/2 content-start justify-items-center gap-6 text-center text-slate-300">
          <span className="relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:from-slate-900 after:to-slate-400 after:content-['']">
            Scroll to see more
          </span>
        </div>
        ...
        >
          <div
            className="w-full max-w-4xl text-center text-6xl font-bold uppercase tracking-tighter font-serif text-slate-100"
        ...
        >
          <p className="flex items-center justify-center gap-3 text-2xl font-medium tracking-tight font-sans text-slate-200">
            <Bracket className="h-12 text-slate-400" />
            <span className="font-sans font-medium">integrate with your fav tech stack</span>
            <Bracket className="h-12 scale-x-[-1] text-slate-400" />
          </p>
        ...
        {/* Block 3 — icons (rotation variant) */}
        <div
          ref={targetRef3}
